...
import os
import sys
vendor_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), '../vendor/open-unmix-pytorch')
...
def test_main(
    ...
    for input_file in input_files:
        ...
        harmonic_signal = estimates['other'].sum(axis=1) / 2 + estimates['bass'].sum(axis=1) / 2
