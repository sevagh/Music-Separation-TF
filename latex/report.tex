...
\citet{masking} provide a full description of different time-frequency masking strategies in audio source separation. In short, a time-frequency mask (or spectral mask, or masking filter), is a matrix of the same size as the complex STFT, which is multiplied with the STFT to mask, filter, or suppress specific time-frequency tiles. A soft mask has real values $\in [0, 1]$, and a binary or hard mask has logical values, i.e. only 0 and 1. Soft masks generally produce higher quality sound, as shown in figure \ref{fig:masks}. The so-called oracle mask is the \textit{ideal} mask for a given signal -- to compute it, the target signal must be known. For example, to compute an oracle mask to create a percussive separation of a mixed song, one must have access to the separate recording of the percussion. The soft mask used in \cite{fitzgerald1, fitzgerald2} is a Wiener filter, of the form:
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=20cm]{../evaluation/heatmaps/1pass_Fitzgerald_PEASS_abbrev.png}}
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=20cm]{../evaluation/heatmaps/1pass_Driedger_PEASS_abbrev.png}}
	\vspace{-1.25em}
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=16cm]{../evaluation/heatmaps/2pass_Driedger_PEASS_abbrev.png}}
	\vspace{-1.25em}
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=20cm]{../evaluation/heatmaps/Jigsaw_PEASS_abbrev.png}}
	\vspace{-1.25em}
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=20cm]{../evaluation/heatmaps/Jigsaw2_PEASS_abbrev.png}}
	\vspace{-1.25em}
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=20cm]{../evaluation/heatmaps/WMDCT_PEASS_abbrev.png}}
	\vspace{-1.25em}
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=20cm]{../evaluation/heatmaps/WMDCT2_PEASS_abbrev.png}}
	\vspace{-1.25em}
...
\begin{figure*}
	\centering
	\makebox[\textwidth]{\includegraphics[width=20cm]{../evaluation/heatmaps/2pass_Fitzgerald_PEASS_abbrev.png}}
	\vspace{-1.25em}
