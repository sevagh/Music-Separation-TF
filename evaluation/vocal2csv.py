...
if __name__ == '__main__':
    header = ['algo', 'H-OPS', 'H-TPS', 'H-IPS', 'H-APS', 'H-ISR', 'H-SIR', 'H-SAR', 'H-SDR', 'H-qTarget', 'H-qInterf', 'H-qArtif', 'H-qGlobal', 'P-OPS', 'P-TPS', 'P-IPS', 'P-APS', 'P-ISR', 'P-SIR', 'P-SAR', 'P-SDR', 'P-qTarget', 'P-qInterf', 'P-qArtif', 'P-qGlobal', 'V-OPS', 'V-TPS', 'V-IPS', 'V-APS', 'V-ISR', 'V-SIR', 'V-SAR', 'V-SDR', 'V-qTarget', 'V-qInterf', 'V-qArtif', 'V-qGlobal']
    ...
    try:
        ...
        print('ecountered exception: {0}'.format(str(e)))
